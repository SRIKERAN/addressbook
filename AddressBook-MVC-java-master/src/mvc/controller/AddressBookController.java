...
public class AddressBookController {
    ...
    private void openAdd(){   
       view.getMainGUIFrame().setVisible(false);
        ...
        choiceListener = new ActionListener() {
            ...
            String status1 = contactDetailsPanel.getStatus().getText();
            String city = contactDetailsPanel.getCity().getText();
            flag = validate();
            if(flag)
            {    
             Person person = new Person();
             person.setData(name,mobile,email,status1,city);
   ...
   */
    ...
    private void openEdit(){
        ...
        dialog.getPanel().setStatus(detailPanel.getStatus().getText());
        dialog.getPanel().setCity(detailPanel.getCity().getText());
        view.getMainGUIFrame().setVisible(false);
        choiceListener = new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
    ...
    public void loadPersons()       
    {
        ...
        nlp.getJList().addListSelectionListener(new ListSelectionListener()
         ...
         detailPanel.getStatus().setEditable(false);
         detailPanel.getCity().setEditable(false);
        }
    }  //loadPersons ends
