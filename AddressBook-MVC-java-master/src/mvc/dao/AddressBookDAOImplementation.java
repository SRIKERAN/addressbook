    ...
    {   
       try
       {
          conn = DBConnection.getInstance().getConnect();
           ...
           String qry;
           qry ="insert into AddressBook values ('"+person.getName()+"','"+person.getMob()+"','"+person.getEmail()+"','"+person.getStatus()+"','"+person.getCity()+"')";
    ...
    @Override
     public void updatePerson(Person person,String name)
     {
         try
       {
           ...
           String qry="update AddressBook set name='"+person.getName()+"',mobile_no='"+person.getMob()+"',email='"+person.getEmail()+"',status='"+person.getStatus()+"',city='"+person.getCity()+"' where name='"+name+"'";
           st.executeUpdate(qry);
    ...
    public void getSelectedName(DetailViewPanel detailPanel,String selectedName)
    {
        try {
            ...
            while(rs.next()){
             ...
             detailPanel.setMobile(rs.getString("mobile_no"));
             detailPanel.setStatus(rs.getString("status"));
